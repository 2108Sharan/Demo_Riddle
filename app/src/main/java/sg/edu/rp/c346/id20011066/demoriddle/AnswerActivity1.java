package sg.edu.rp.c346.id20011066.demoriddle;
...
public class AnswerActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String answersSelected = intentReceived.getStringExtra("Answer");
        tvAnswer.setText(questionsSelected + " answer is: " + answersSelected);
    }
    @Override
